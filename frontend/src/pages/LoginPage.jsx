...
export const Login = () => {
  ...
  return (
    ...
    <section className="relative flex flex-col justify-center items-center ">
       ...
       <BackHome fill={"#FFFFFF"} className={"text-cardBg flex flex-row gap-x-3 absolute left-[30px] top-[30px]"}/>
      ...
      <div className="flex justify-center sm:pt-[80px] ">
        <form onSubmit={handleLoginSubmit} className="flex flex-col sm:gap-y-[80px] items-center" >
          ...
          <button type="submit" className="text-bg2 bg-bg1 rounded sm:text-h2sm lg:text-h2md py-[5px] px-[10px]">Login</button>
        </form>
