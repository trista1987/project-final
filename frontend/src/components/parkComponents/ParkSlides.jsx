        ...
        >
          {parkData.map((park) => (
            ...
            >
                ...
                />
                 <button onClick={()=> handleToggleFavPark(park) } className="absolute flex justify-center items-center bg-bg1 w-[30px] h-[30px] rounded-tl rounded-br right-[0px] bottom-[0px]">
